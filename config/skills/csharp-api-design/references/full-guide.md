...
Use the [dotnet-serialization guide](../../dotnet-serialization/references/full-guide.md#api-wire-rollout-example) for reader-first rollout examples and compatibility requirements.
